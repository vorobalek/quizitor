...
namespace Quizitor.Migrator.Migrations
{
    ...
    [Migration("20250121165621_ef_init")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.BotCommand", b =>
                {
                    ...
                    b.ToTable("bot_command", (string)null);
                });
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.BotInteraction", b =>
                {
                    ...
                    b.ToTable("bot_interaction", (string)null);
                });

            modelBuilder.Entity("Quizitor.Data.Entities.Events.TimingNotifyEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_timing_notify");

                    b.HasIndex("TimingId")
                        .IsUnique()
                        .HasDatabaseName("ix_timing_notify_timing_id");

                    b.ToTable("timing_notify", "events");
                });

            modelBuilder.Entity("Quizitor.Data.Entities.Events.TimingStopEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_timing_stop");

                    b.HasIndex("TimingId")
                        .IsUnique()
                        .HasDatabaseName("ix_timing_stop_timing_id");

                    b.ToTable("timing_stop", "events");
                });
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.Option", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.Question", b =>
                {
                    ...
                    b.HasIndex("RoundId")
                        .HasDatabaseName("ix_question_round_id");
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.Round", b =>
                {
                    ...
                    b.HasIndex("GameId")
                        .HasDatabaseName("ix_round_game_id");
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.Submission", b =>
                {
                    ...
                    b.Property<int>("CheckingResult")
                        .HasColumnType("integer")
                        .HasColumnName("checking_result");
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.Timing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("QuestionId")
                        .HasDatabaseName("ix_timing_question_id");

                    b.HasIndex("SessionId")
                        .HasDatabaseName("ix_timing_session_id");

                    b.ToTable("timing", (string)null);
                });
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.User", b =>
                {
                    ...
                    b.Property<string>("PromptSubject")
                        .HasMaxLength(1024)
                        .HasColumnType("character varying(1024)")
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.Events.TimingNotifyEvent", b =>
                {
                    b.HasOne("Quizitor.Data.Entities.Timing", "Timing")
                        .WithMany()
                        .HasForeignKey("TimingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_timing_notify_timing_timing_id");
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.Events.TimingStopEvent", b =>
                {
                    b.HasOne("Quizitor.Data.Entities.Timing", "Timing")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_timing_stop_timing_timing_id");
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.Timing", b =>
                {
                    b.HasOne("Quizitor.Data.Entities.Question", "Question")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_timing_question_question_id");
                    ...
                    b.HasOne("Quizitor.Data.Entities.Session", "Session")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_timing_session_session_id");
