...
namespace Quizitor.Migrator.Migrations
{
    ...
    [Migration("20250730090422_ef_alter_question_add_subbmission_notification_type")]
    partial class ef_alter_question_add_subbmission_notification_type
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.MailingFilterBot", b =>
                {
                    b.Property<int>("MailingProfileId")
                        .HasColumnType("integer")
                        .HasColumnName("mailing_profile_id");
                    ...
                    b.HasKey("MailingProfileId", "BotId")
                        .HasName("pk_mailing_filter_bot");

                    b.HasIndex("BotId")
                        .HasDatabaseName("ix_mailing_filter_bot_bot_id");

                    b.ToTable("mailing_filter_bot", "public");
                });

            modelBuilder.Entity("Quizitor.Data.Entities.MailingFilterGame", b =>
                {
                    b.Property<int>("MailingProfileId")
                        .HasColumnType("integer")
                        .HasColumnName("mailing_profile_id");
                    ...
                    b.HasKey("MailingProfileId", "GameId")
                        .HasName("pk_mailing_filter_game");

                    b.HasIndex("GameId")
                        .HasDatabaseName("ix_mailing_filter_game_game_id");

                    b.ToTable("mailing_filter_game", "public");
                });

            modelBuilder.Entity("Quizitor.Data.Entities.MailingFilterSession", b =>
                {
                    b.Property<int>("MailingProfileId")
                        .HasColumnType("integer")
                        .HasColumnName("mailing_profile_id");
                    ...
                    b.HasKey("MailingProfileId", "SessionId")
                        .HasName("pk_mailing_filter_session");

                    b.HasIndex("SessionId")
                        .HasDatabaseName("ix_mailing_filter_session_session_id");

                    b.ToTable("mailing_filter_session", "public");
                });

            modelBuilder.Entity("Quizitor.Data.Entities.MailingFilterTeam", b =>
                {
                    b.Property<int>("MailingProfileId")
                        .HasColumnType("integer")
                        .HasColumnName("mailing_profile_id");
                    ...
                    b.HasKey("MailingProfileId", "TeamId")
                        .HasName("pk_mailing_filter_team");

                    b.HasIndex("TeamId")
                        .HasDatabaseName("ix_mailing_filter_team_team_id");

                    b.ToTable("mailing_filter_team", "public");
                });

            modelBuilder.Entity("Quizitor.Data.Entities.MailingFilterUser", b =>
                {
                    b.Property<int>("MailingProfileId")
                        .HasColumnType("integer")
                        .HasColumnName("mailing_profile_id");
                    ...
                    b.HasKey("MailingProfileId", "UserId")
                        .HasName("pk_mailing_filter_user");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_mailing_filter_user_user_id");

                    b.ToTable("mailing_filter_user", "public");
                });

            modelBuilder.Entity("Quizitor.Data.Entities.MailingProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("BotTypes")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasColumnName("bot_types");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_mailing_profile");

                    b.HasIndex("OwnerId")
                        .HasDatabaseName("ix_mailing_profile_owner_id");

                    b.HasIndex("MailingId", "OwnerId")
                        .IsUnique()
                        .HasDatabaseName("ix_mailing_profile_mailing_id_owner_id");

                    b.ToTable("mailing_profile", "public");
                });
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.Question", b =>
                {
                    ...
                    b.Property<int>("SubmissionNotificationType")
                        .HasColumnType("integer")
                        .HasColumnName("submission_notification_type");
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.FirstAcceptedAnswerQuestionRule", b =>
                {
                    b.HasBaseType("Quizitor.Data.Entities.QuestionRule");
                    ...
                    b.HasDiscriminator().HasValue("first_accepted_answer");
                });
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.MailingFilterBot", b =>
                {
                    b.HasOne("Quizitor.Data.Entities.Bot", "Bot")
                        .WithMany("MailingFilters")
                        .HasForeignKey("BotId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_mailing_filter_bot_bot_bot_id");

                    b.HasOne("Quizitor.Data.Entities.MailingProfile", "MailingProfile")
                        .WithMany("Bots")
                        .HasForeignKey("MailingProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_mailing_filter_bot_mailing_profile_mailing_profile_id");

                    b.Navigation("Bot");

                    b.Navigation("MailingProfile");
                });
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.MailingFilterGame", b =>
                {
                    b.HasOne("Quizitor.Data.Entities.Game", "Game")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_mailing_filter_game_game_game_id");
                    ...
                    b.HasOne("Quizitor.Data.Entities.MailingProfile", "MailingProfile")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_mailing_filter_game_mailing_profile_mailing_profile_id");
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.MailingFilterSession", b =>
                {
                    b.HasOne("Quizitor.Data.Entities.MailingProfile", "MailingProfile")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_mailing_filter_session_mailing_profile_mailing_profile_id");
                    ...
                    b.HasOne("Quizitor.Data.Entities.Session", "Session")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_mailing_filter_session_session_session_id");
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.MailingFilterTeam", b =>
                {
                    b.HasOne("Quizitor.Data.Entities.MailingProfile", "MailingProfile")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_mailing_filter_team_mailing_profile_mailing_profile_id");
                    ...
                    b.HasOne("Quizitor.Data.Entities.Team", "Team")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_mailing_filter_team_team_team_id");
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.MailingFilterUser", b =>
                {
                    b.HasOne("Quizitor.Data.Entities.MailingProfile", "MailingProfile")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_mailing_filter_user_mailing_profile_mailing_profile_id");
                    ...
                    b.HasOne("Quizitor.Data.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_mailing_filter_user_user_user_id");
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.MailingProfile", b =>
                {
                    b.HasOne("Quizitor.Data.Entities.Mailing", "Mailing")
                        .WithMany("Profiles")
                        .HasForeignKey("MailingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_mailing_profile_mailing_mailing_id");

                    b.HasOne("Quizitor.Data.Entities.User", "Owner")
                        .WithMany("OwnedMailingFilters")
                        .HasForeignKey("OwnerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_mailing_profile_user_owner_id");
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.User", b =>
                {
                    ...
                    b.Navigation("OwnedMailingFilters");
