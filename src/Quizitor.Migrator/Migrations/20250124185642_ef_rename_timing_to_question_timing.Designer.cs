...
namespace Quizitor.Migrator.Migrations
{
    ...
    [Migration("20250124185642_ef_rename_timing_to_question_timing")]
    partial class ef_rename_timing_to_question_timing
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.Timing", b =>
                {
                    ...
                    b.ToTable("question_timing", (string)null);
                });
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.Events.TimingNotifyEvent", b =>
                {
                    b.HasOne("Quizitor.Data.Entities.Timing", "Timing")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_timing_notify_question_timing_timing_id");
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.Events.TimingStopEvent", b =>
                {
                    b.HasOne("Quizitor.Data.Entities.Timing", "Timing")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_timing_stop_question_timing_timing_id");
