...
namespace Quizitor.Migrator.Migrations
{
    ...
    [Migration("20250328121242_ef_add_mailing_profile")]
    partial class ef_add_mailing_profile
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.MailingProfile", b =>
                {
                    ...
                    b.OwnsOne("System.Collections.Generic.Dictionary<Quizitor.Data.Enums.BotType, Quizitor.Data.Enums.MailingFilterFlagType>", "BotTypes", b1 =>
                        {
                            b1.Property<int>("MailingProfileId")
                                .HasColumnType("integer");

                            b1.HasKey("MailingProfileId");

                            b1.ToTable("mailing_profile", "public");

                            b1.ToJson("bot_types");

                            b1.WithOwner()
                                .HasForeignKey("MailingProfileId")
                                .HasConstraintName("fk_mailing_profile_mailing_profile_id");
                        });
