...
namespace Quizitor.Migrator.Migrations
{
    ...
    [Migration("20250324195923_ef_alter_team_member_add_index_session_id_user_id")]
    partial class ef_alter_team_member_add_index_session_id_user_id
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.TeamLeader", b =>
                {
                    ...
                    b.HasKey("TeamId", "SessionId", "UserId")
                        .HasName("pk_team_leader");

                    b.HasIndex("SessionId")
                        .HasDatabaseName("ix_team_leader_session_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_team_leader_user_id");

                    b.ToTable("team_leader", (string)null);
                });
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.TeamMember", b =>
                {
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_team_member_user_id");

                    b.HasIndex("SessionId", "UserId")
                        .IsUnique()
                        .HasDatabaseName("ix_team_member_session_id_user_id");
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.UserPrompt", b =>
                {
                    ...
                    b.ToTable("user_prompt", (string)null);
                });
            ...
            modelBuilder.Entity("Quizitor.Data.Entities.AnyAnswerQuestionRule", b =>
                {
                    ...
                    b.ToTable("question_rule", (string)null);
