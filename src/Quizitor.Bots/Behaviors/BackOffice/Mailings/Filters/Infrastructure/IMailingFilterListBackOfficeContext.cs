...
internal interface IMailingFilterListBackOfficeContext<TEntity> : IMailingProfileBackOfficeContext
{
    TEntity[] Entities { get; }
    int PageNumber { get; }
    int PageCount { get; }

    static IMailingFilterListBackOfficeContext<TEntity> Create(
        TEntity[] entities,
        int pageNumber,
        int pageCount,
        IMailingProfileBackOfficeContext baseContext)
    {
        return new MailingFilterListBackOfficeContext(
            entities,
            pageNumber,
            pageCount,
            baseContext.Mailing,
    ...
    private record MailingFilterListBackOfficeContext(
        TEntity[] Entities,
        int PageNumber,
        int PageCount,
        Mailing Mailing,
        ...
        string? QrData,
        IIdentity Identity) : IMailingFilterListBackOfficeContext<TEntity>;
}