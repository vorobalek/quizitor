...
internal interface IRatingFinalFullGameServerContext : IGameServerContext
{
    ...
    private record RatingFinalFullGameServerContext(
        RatingFullLineDto[] Lines,
        int RatingPageNumber,
        TimeSpan? TimeSinceLastUpdate,
        ...
        string? QrData,
        IIdentity Identity) : IRatingFinalFullGameServerContext;
}